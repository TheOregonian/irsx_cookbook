...
class StreamExtractor(object):
    ...
    def run_parts(self, this_capture_sked, parsed_sked, sked, ez_exec=""):
    ...
    def run_groups(self, this_capture_sked, parsed_sked, sked, ez_exec=""):
    ...
    def run_filing(self, filing, ez_exec=""):
        ...
        for sked in self.data_capture_dict.keys():
            if sked in schedule_list:
                ...
                try:
                     ...
                     skip_groups = True
                if not skip_groups:
                    self.run_groups(this_capture_sked, parsed_sked, sked, ez_exec=ez_exec)
                ...
                try:
                     ...
                     skip_parts = True
                if not skip_parts:
                    self.run_parts(this_capture_sked, parsed_sked, sked, ez_exec=ez_exec)
